...
return [
    ...
    'password' => [
        ...
        'uncompromised' => "Le :attribute indiqué figure dans une fuite de données connue. Veuillez choisir un autre :attribute.",
    ],
    ...
    'attributes' => [
        ...
        'full_name' => "nom du titulaire de l'envoi",
        'rib' => "numéro de compte de l'envoi",
        'reference' => 'détails supplémentaires',
        'receipt' => 'reçu',
        ...
        'whatsapp' => 'WhatsApp',
        'support_email' => 'e-mail du support',
        'slug' => 'slug',
        'video' => 'fichier vidéo',
