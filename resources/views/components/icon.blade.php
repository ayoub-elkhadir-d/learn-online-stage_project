...
@php
/**
 * Inline Lucide icon paths (MIT licensed, https://lucide.dev). Server-rendered
 * SVG rather than an icon font or a JS icon-swap library — no FOUC, no extra
 * request, no CLS while a font/script loads.
 */
$paths = [
    ...
    'picture-in-picture' => '<path d="M8 4H4a2 2 0 0 0-2 2v3"/><path d="M4 16v2a2 2 0 0 0 2 2h1"/><path d="M9 20h6"/><path d="M20 14v4a2 2 0 0 1-2 2h-1"/><rect x="12" y="8" width="10" height="7" rx="2"/>',
    ...
    'graduation-cap' => '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1.66 2.69 3 6 3s6-1.34 6-3v-5"/>',
    ...
    'maximize-2' => '<path d="M15 3h6v6"/><path d="m21 3-7 7"/><path d="m3 21 7-7"/><path d="M3 15v6h6"/>',

    // ---- Asset attachment types (Course Assets timeline) ----
    ...
    'file-spreadsheet' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h8"/><path d="M8 17h8"/><path d="M11 13v6"/>',
    'presentation' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="m9.5 12.5 3 2-3 2z"/>',
    'archive' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M11 11h2"/><path d="M11 14h2"/><path d="M11 17h2"/>',
    'music' => '<path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/>',
    'link' => '<path d="M10 13a5 5 0 0 0 7.07 0l1.93-1.93a5 5 0 0 0-7.07-7.07L10.5 5.5"/><path d="M14 11a5 5 0 0 0-7.07 0L4.99 12.93a5 5 0 0 0 7.07 7.07L13.5 18.5"/>',
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
     ...
     {{ $attributes->merge(['class' => $class]) }} aria-hidden="true">{!! $svg !!}</svg>
